      ...
      <property name="initialAssignment" class="InitialVariableAssignment">
        ...
        <property name="assignments" class="AttributeAssignments">
          <property name="EntityId" class="AttributeAssignment">
            <property name="attributeValue" class="String">42516721</property>
            <property name="currentlyAssigned" class="Boolean">true</property>
          ...
          <property name="FacebookURL" class="AttributeAssignment">
            <property name="attributeValue" class="String">https://www.facebook.com/lakmini.erandika.1</property>
            <property name="currentlyAssigned" class="Boolean">true</property>
