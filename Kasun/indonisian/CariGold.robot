...
<object class="GenericRobot2" serializationversion="2">
  ...
  "Country" : "ID"
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="11">Date</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" idref="1"/>
      </property>
    </object>
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="12">Title</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" idref="1"/>
      </property>
    </object>
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      ...
      <object class="Transition" serializationversion="3" id="22">
        <property name="name" class="String" id="23">Repeat</property>
      ...
      <object class="Transition" serializationversion="3" id="37">
        ...
        <property name="stepAction" class="ForEachTag" serializationversion="0">
          ...
          <property name="classes" idref="28"/>
      ...
      <object class="Transition" serializationversion="3" id="40">
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          <property name="stringExpr" class="Expression" serializationversion="1">
            <property name="text" class="String">replaceText(replaceText(CommentDate," ","T"),".0","")</property>
          </property>
          <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
      ...
      <object class="Transition" serializationversion="3" id="57">
        <property name="name" class="String" id="58">Next</property>
