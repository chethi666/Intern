...
<object class="GenericRobot2" serializationversion="2">
  ...
  <property name="variables" class="Variables">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="3">fromId</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" idref="2"/>
      </property>
    </object>
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="4">relationshipJSON</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" idref="1"/>
  ...
  "Relationships" : [
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="5">ProfileID</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" idref="2"/>
      </property>
    </object>
      ...
      <property name="initialAssignment" class="InitialVariableAssignment">
        ...
        <property name="assignments" class="AttributeAssignments">
          <property name="EntityId" class="AttributeAssignment">
            <property name="attributeValue" class="String">34001642</property>
            <property name="currentlyAssigned" class="Boolean">true</property>
          ...
          <property name="FacebookURL" class="AttributeAssignment">
            <property name="attributeValue" class="String">https://www.facebook.com/profile.php?id=100009446811403</property>
            <property name="currentlyAssigned" class="Boolean">true</property>
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="10">
        <property name="name" class="String">V 1.1</property>
      ...
      <object class="Transition" serializationversion="3" id="26">
        ...
        <property name="stepAction" class="CallRESTWebService2" serializationversion="1">
          <property name="urlProvider" class="Expression" serializationversion="1">
            <property name="text" class="String">Config.NodeServer + "api/entity/randomavatar/facebook/FOLLOWERS"</property>
          </property>
...
&lt;&lt;</property>
      ...
      <object class="Transition" serializationversion="3" id="56">
        <property name="name" class="String" id="57">Load Page</property>
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.AttributeURLProvider2" serializationversion="1">
            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
              <property name="name" class="String">FacebookDetails.FacebookURL</property>
      ...
      <object class="Transition" serializationversion="3" id="59">
        <property name="name" class="String" id="60">Close Window</property>
        <property name="stepAction" class="CloseWindow">
          <property name="browserConfigurationSpecification" class="BrowserConfigurationSpecificationWebKit" serializationversion="23">
      ...
      <object class="Transition" serializationversion="3" id="80">
        ...
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ExpressionURLProvider2">
            <property name="expression" class="String">&gt;&gt;https://m.facebook.com/subscribe/lists/?id=&lt;&lt;+fromId+&gt;&gt;&amp;amp;f=1&amp;amp;t=in&lt;&lt;</property>
          </property>
          <property name="browserConfigurationSpecification" class="BrowserConfigurationSpecificationWebKit" serializationversion="23">
            <property name="SSLUsage" idref="13"/>
            <property name="httpUserAgent" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
...
Default value changed: httpUserAgent null -&gt; kapow.robot.plugin.common.support.expression.stringexpr.PresetUserAgentStringExpression(userAgent="Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.110 Safari/537.36")</property>
      ...
      <object class="Transition" serializationversion="3" id="113">
        ...
        <property name="stepAction" class="CallRESTWebService2" serializationversion="1">
          <property name="urlProvider" class="Expression" serializationversion="1">
            <property name="text" class="String">&gt;&gt;&lt;&lt;+Config.DocumentRepository+&gt;&gt;documents?query=Entity1Name: "&lt;&lt; + urlEncode(FacebookRelationships.Entity1Name) + &gt;&gt;" AND Entity2Name:"&lt;&lt; + urlEncode(FacebookRelationships.Entity2Name) + &gt;&gt;"&amp;schema=SOCIAL_MEDIA&lt;&lt;</property>
          </property>
          <property name="output" class="kapow.robot.plugin.common.stateprocessor.rest.ToVariableOutputSpecification" serializationversion="1">
            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
...
Default value changed: httpUserAgent null -&gt; kapow.robot.plugin.common.support.expression.stringexpr.PresetUserAgentStringExpression(userAgent="Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.110 Safari/537.36")</property>
 ...
 "Text":"&lt;&lt; +   FacebookRelationships.Entity1Name + &gt;&gt; is facebook friend &lt;&lt; +  FacebookRelationships.Entity2Name + &gt;&gt;",
 "Source":  "https://www.facebook.com/",
 "Schema": "SOCIAL_MEDIA",
 "Entity1Name":  "&lt;&lt; + FacebookRelationships.Entity1Name + &gt;&gt;",
 "Entity1ID":  "&lt;&lt; + FacebookRelationships.Entity1ID + &gt;&gt;",
 "Entity1Photo":  "&lt;&lt; + FacebookRelationships.Entity1Photo + &gt;&gt;",
 "Entity2Name":  "&lt;&lt; + FacebookRelationships.Entity2Name + &gt;&gt;",
 "Entity2ID": "&lt;&lt; + FacebookRelationships.Entity2ID + &gt;&gt;",
 "Entity2Photo":  "&lt;&lt; + FacebookRelationships.Entity2Photo + &gt;&gt;",
 "SocialNetwork": "Facebook",
"Persons": [
    "&lt;&lt; + FacebookRelationships.Entity1Name + &gt;&gt;", "&lt;&lt; + FacebookRelationships.Entity2Name + &gt;&gt;"
  ],
"Tags": ["&lt;&lt; + FacebookRelationships.Entity1Name+ &gt;&gt;"],
"ScheduleId": "&lt;&lt;+FacebookDetails.ScheduleId+&gt;&gt;"
}&lt;&lt;</property>
          </property>
          <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
